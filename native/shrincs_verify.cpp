...
// Full BIP341 SIGHASH_DEFAULT + Tapscript extension, domain-separated for B32.
...
int main(int argc, char** argv) {
    try {
        if (argc < 3) throw std::runtime_error("usage: btc-pq-shrincs-verify spend.hex parent0.hex [parent1.hex ...]");
